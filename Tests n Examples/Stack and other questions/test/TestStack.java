...
public class TestStack {
    ...
    public static ArrayList<Boolean> testStackInstance() {
        ...
        results.add(Assert.assertEqual(-1, stack.getTopIndex(), "Stack top position"));

        // 4 The stack top element must be 42
        stack.push(42);
        results.add(Assert.assertEqual(42, stack.top(), "Stack top element"));

        // 5 The stack top element must be 20
        stack.push(20);
        results.add(Assert.assertEqual(20, stack.top(), "Stack top element"));
        ...
        results.add(Assert.assertEqual(0, stack.getTopIndex(), "Stack top position"));
        ...
        results.add(Assert.assertEqual(9, stack.getTopIndex(), "Stack top position"));
        ...
        stack.push(993);
        results.add(Assert.assertNotEqual(993, stack.top(), "Stack top"));
